	...
	return ( 
		<section className="pt-60 md:pt-40 md:px-16 w-screen mb-12 bg-slate-100 mt-40 md:mt-28" data-aos="fade-right">
			...
			<div className="flex flex-col md:flex-row mt-16 w-full" data-aos="zoom-in">
				<div className="flex flex-col justify-center items-center w-[100%] md:w-[30%] crypto h-[433px] text-center  rounded-xl px-2">
				...
				<div className="flex flex-col justify-center items-center md:w-[30%] crypto h-[433px] my-4 md:my-0 md:mx-16 text-center  rounded-xl">
				...
				<div className="flex flex-col justify-center items-center md:w-[30%] crypto h-[433px] text-center  rounded-xl px-2">
